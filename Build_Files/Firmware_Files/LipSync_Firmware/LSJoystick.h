...
pointIntType LSJoystick::linearizeOutput(pointIntType inputPoint){
  ...
  // Linearly interpolate the output point from the range of -1023 — 1023 to -rangeValue — rangeValue
  // Range value depends on the operating mode (Mouse or Gamepad)
  // Mouse, depending on _rangeLevel, ranges from 2 — 18
  // Gamepad does not depend on _rangeLevel, and is always 128
